    ...
    <div className="page-container">
      ...
      <Modal isOpen={isInfoModalOpen} onClose={() => setIsInfoModalOpen(false)}>
        <div className="info-modal-content">
          ...
          {selectedModel === 'ms' ? (
            <>
              <h3>{t('modals.single.ms.title')}</h3>
              <p>{t('modals.single.ms.desc')}</p>
            ...
            <>
              <h3>{t('modals.single.minimal.title')}</h3>
              <p>{t('modals.single.minimal.desc')}</p>
              <h3>{t('modals.math_model')}</h3>
              ...
              <p><strong>{t('modals.single.minimal.vars')}</strong></p>
              <p>{t('modals.single.minimal.currents')}</p>
            </>
          )}
