...
const MitchellSchaeffer1DPage = ({ onBack }) => {
  ...
  return (
    <div className="page-container">
      ...
      <h1>{t('home.models.ms_1d.title')}</h1>
      ...
      <Modal isOpen={isInfoModalOpen} onClose={() => setIsInfoModalOpen(false)}>
        <div className="info-modal-content">
          <h2>{t('home.models.ms_1d.title')}</h2>
          
          <h3>{t('modals.math_model')}</h3>
          <p>{t('modals.ms1d.desc')}</p>
          <p>As equações de reação-difusão são:</p>
          <ul>
            <li><code>{t('modals.ms1d.eq')}</code></li>
          ...
          <ul>
            ...
            <li>{t('params.dx')}</li>
            <li>{t('params.dt')}</li>
            <li>{t('params.posição_do_estímulo')}</li>
