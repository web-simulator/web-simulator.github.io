                        ...
                        {simulationData.length > 0 && (
                             <>
                                ...
                                <ExportModal 
                                    ...
                                    onExportPng={() => exportToPng(chartRef, 'fhn_1d_plot')}
                                    onExportGif={handleExportGif}
                                    onExportData={() => {
                                        // Passamos uma flag para indicar que é FHN, e assim, usar a key 'w' na função de exportação.
                                        export1DToXDMF(simulationData, params => ({...params, modelType: 'fhn'}), 'fhn_1d_data')
                                    }}
                                />
